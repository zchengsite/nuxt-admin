...
const actions = {
  ...
  updateTheme({ commit }, { menuValue, navValue }) {
    commit(types.UPDATE_THEME, { menuValue, navValue });
  },
  pushTab({ commit }, { tab }) {
...
const mutations = {
  ...
  [types.UPDATE_THEME](state, { menuValue, navValue }) {
    const theme = {
      'site-menubar-light': menuValue,
      'navbar-inverse': navValue,
    };
    state.theme = theme;
  },
